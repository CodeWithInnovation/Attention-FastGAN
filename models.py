...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024):
        ...
        self.se_64  = AttentionBlock(nfc[4], nfc[64])
        self.se_128 = AttentionBlock(nfc[8], nfc[128])
        self.se_256 = AttentionBlock(nfc[16], nfc[256])
        ...
        if im_size > 256:
            ...
            self.se_512 = AttentionBlock(nfc[32], nfc[512])
        if im_size > 512:
...
class Discriminator(nn.Module):
    def __init__(self, ndf=64, nc=3, im_size=512):
        ...
        self.se_2_16 = AttentionBlock(nfc[512], nfc[64])
        self.se_4_32 = AttentionBlock(nfc[256], nfc[32])
        self.se_8_64 = AttentionBlock(nfc[128], nfc[16])
